...
def board_comment_add(board_id, site, userid, comment):
    try:
        ...
        collection = db_controller.find(
            'Comment', {"board_id": board_id, "site": site})
...
def board_reply_add(board_id, site, userid, reply, parrent_comment):
    try:
        ...
        replys = db_controller.find(
            'Comment', {"_id": parrent_comment})["reply"]
        replys.append(comment_data)
        db_controller.update_one(
            "Comment", {"_id": parrent_comment}, {"$set": replys})
